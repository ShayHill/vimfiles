...
nnoremap <buffer> <leader>t :update<CR>:ScratchTermReplaceUV python -m pytest<t_ku>
inoremap <buffer> <leader>t <ESC>:update<CR>:ScratchTermReplaceUV python -m pytest<t_ku>
